...
export const getCallingDialog = (rejectCallHandler) =>{
    ...
    hangUpImg.classList.add('dialog_button_image')
    const hangUpImgPath = './utils/images/acceptCall.png'
    hangUpImg.src = hangUpImgPath
    hangupCallButton.append(hangUpImg)
...
export const getInfoDialog = (dialogTitle, dialogDesc) =>{
    ...
    description.innerHTML = dialogDesc
